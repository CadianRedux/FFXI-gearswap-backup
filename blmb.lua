function get_sets() -- Get all your equipment sets function
 -- Set bindings --
	send_command('bind f9 gs l blm.lua; input /echo Nuking Mode') -- Switch to nuking lua by hitting F9
	send_command('bind f10 gs l blmb.lua; input /echo Bursting Mode') -- Switch to bursting lua by hitting F10
 -- End set bindings --
 ...
 -- Fastcast Sets --
    ...
    back={ name="Mecisto. Mantle", augments={'Cap. Point+42%','HP+14','Mag. Acc.+2','DEF+11',}},}
 ...
 -- Midcast sets --
	sets.midcast = {}
	sets.midcast.Burst = {main={ name="Lathi", augments={'INT+15','"Mag.Atk.Bns."+15','Mag. Acc.+15',}},
	sub="Willpower Grip",
	ammo="Ghastly Tathlum +1",
	head="Jhakri Coronal +1",
	body="Spae. Coat +1",
	hands={ name="Amalric Gages", augments={'INT+10','Mag. Acc.+15','"Mag.Atk.Bns."+15',}},
	legs={ name="Merlinic Shalwar", augments={'Magic burst mdg.+10%','MND+8',}},
	...
	sets.midcast.MACC =	{main={ name="Lathi", augments={'INT+13','"Mag.Atk.Bns."+13','Mag. Acc.+13',}},
    sub="Willpower Grip",
    ammo="Kalboron Stone",
    head="Pixie Hairpin +1",
    body={ name="Vanya Robe", augments={'Healing magic skill +9','"Cure" spellcasting time -2%',}},
    hands={ name="Amalric Gages", augments={'INT+10','Mag. Acc.+15','"Mag.Atk.Bns."+15',}},
    legs={ name="Psycloth Lappas", augments={'MP+80','Mag. Acc.+15','"Fast Cast"+7',}},
